...
* @returns {Result}
*/
export function run_stack(src) {
    const ptr0 = passStringToWasm0(src, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_stack(ptr0, len0);
...
export class Result {
    ...
    * @returns {Result}
    */
    static new(output, log) {
        const ptr0 = passStringToWasm0(output, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(log, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.result_new(ptr0, len0, ptr1, len1);
        return Result.__wrap(ret);
    }
    /**
    * @returns {string}
    */
    output() {
        ...
        try {
            ...
            wasm.result_output(retptr, this.__wbg_ptr);
    ...
    */
    log() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.result_log(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_prompt_1a7b517699a71a7b = function(arg0, arg1, arg2) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('web_stack_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
